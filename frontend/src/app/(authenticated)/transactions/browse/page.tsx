            ...
            <div className="p-4 sm:p-6 lg:p-8">
                ...
                <Card className="mb-6 shadow-md bg-background">
                    <CardHeader className="pb-4">
                        <CardTitle className="text-lg sm:text-xl">Search Transactions</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-sm font-medium">Member ID (మెంబర్ ఐడి)</FormLabel>
                                                <FormControl>
                                                    <Input 
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-sm font-medium">Supervisor ID (సూపర్వైజర్ ఐడి)</FormLabel>
                                                <FormControl>
                                                    <Input 
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-sm font-medium">Transaction Type (ట్రాన్సాక్షన్ రకం)</FormLabel>
                                                <Select 
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-sm font-medium">Amount (అమౌంట్)</FormLabel>
                                                <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-sm font-medium">Date Range (డేట్ రేంజ్)</FormLabel>
                ...
                <div className="shadow-md bg-background rounded-lg">
                    <div className="pb-4 flex justify-between items-center border-b px-6 pt-6">
                        <span className="text-lg sm:text-xl font-semibold">Transaction Results</span>
                    </div>
